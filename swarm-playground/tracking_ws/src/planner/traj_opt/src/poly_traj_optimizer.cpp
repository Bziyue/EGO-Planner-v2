...
namespace ego_planner
{
      ...
      double &final_cost)
  {
    ...
    integral_cost_func_.object_p = object_p_;
    integral_cost_func_.object_v = object_v_;
    integral_cost_func_.object_q = object_q_;
    integral_cost_func_.start_tracking = satrt_tracking_;
