...
namespace ego_planner
{
  ...
  private:
    ...
    double wei_tracking_{0.0};
    Eigen::Vector3d relative_tracking_p_{Eigen::Vector3d::Constant(-10000.0)};
    Eigen::Vector3d object_p_{Eigen::Vector3d::Constant(-10000.0)};
    Eigen::Vector3d object_v_{Eigen::Vector3d::Constant(-10000.0)};
    Eigen::Quaterniond object_q_{Eigen::Quaterniond(1.0, 0.0, 0.0, 0.0)};
    bool satrt_tracking_{false};
