...
namespace ego_planner
{
      ...
      double &final_cost)
  {
    ...
    integral_cost_func_.wei_formation = wei_formation_;
    integral_cost_func_.formation_num = formation_num_;
    integral_cost_func_.formation = formation_;
    integral_cost_func_.formation_start = formation_start_;
    integral_cost_func_.formation_end = formation_end_;
  ...
  {
    formation_start_ = formation_start_pt;
    formation_end_ = formation_end_pt;
  }
